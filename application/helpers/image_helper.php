...
if (!function_exists('file_input')) {
	...
	function file_input(string $nameContainer = null, bool $require = true, $oldImagePath = null, string $ImageHeight = "60", bool $MultipleImages = false)
	{
		...
		<div class="row">
			<div class="col-12 <?php is_array($oldImagePath) or print('col-md-6') ?> mb-4" id="place-<?php echo $nameContainer; ?>">
				...
				<?php else : ?>
					<div class=" <?php echo $nameContainer ?>-gallery">
						...
						<?php vars_exists($ImageHeight) and print($ImageHeight); ?>px" id="global_img_upload_img_placeholder">
						<?php if ($require === true) : ?>
			...
			<div class="col-12 <?php is_array($oldImagePath) or print('col-md-6') ?> mb-4" id="input-<?php echo $nameContainer; ?>">
				<div class="form-group">
					...
					<div class="custom-file">
						<?php if (!empty($oldImagePath)) : ?>
							...
							<?php endif; ?>
						<?php endif; ?>
						<input type="file" class="custom-file-input" id="<?php echo $nameContainer; ?>" <?php $MultipleImages and print('multiple'); ?> name="<?php echo $nameContainer; ?>" accept="image/jpg, image/jpeg, image/png" style="display:none;">
						<label class="custom-file-label bg-light border border-light" for="<?php echo $nameContainer; ?>" style="display:none;" id="global_label_inpt_box">Choose Image</label>
					</div>
				</div>
			</div>
		</div>
		<script>
			$(document).on('click', '#global_img_upload_img_placeholder', function() {
				$('#global_label_inpt_box').click();
			})
		</script>
	<?php
