                ...
                <div class="col-lg-8">
                    <form class="form-contact contact_form" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="button button-contactForm btn_1" name="submit" value="sdfd">Send Message</button>
                        </div>
                    </form>
                </div>
                <div class="col-lg-4">
                    <div class="media contact-info">
                        ...
                        <div class="media-body">
                            <p><?php is($site->site_address, 'show'); ?></p>
                        </div>
                    </div>
                    <div class="media contact-info">
                        <span class="contact-info__icon"><i class="ti-tablet"></i></span>
                        <div class="media-body">
                            <h3><?php is($site->site_mobile, 'show'); ?></h3>
