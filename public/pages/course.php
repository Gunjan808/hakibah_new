            ...
            <div class="col-12 col-md-6 d-inline-flex ">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>course/<?php is($university->slug, 'show'); ?>/<?php is($course->slug, 'show'); ?>"><?php is($course->title, 'showCapital') ?> &nbsp;(<?php is($course->course_code, 'show') ?>)</a></li>
                    </ol>
                </nav>
            </div>
                            ...
                            <div class="col-md-8">
                                <div class="py-2 px-4 my-3 mb-4" style="background: #d7f0ff;">
                                    <form action="" method="post">
                                        ...
                                        <small><?php echo $data['total_users_following_course'] ?> Students in this course can reply to you!</small>
                                        <div class="row mt-3">
                                        ...
                                        <div class="col-12 pb-3 text-right">
                                            <input type="hidden" name="course_id" value="<?= $data['course']->id ?>"> <button class="btn btn-primary rounded-pill px-4 py-2" type="submit" name="course_post_submit">
                                                Submit
                                            </button>
                                        </div>
                                    </form>
                                ...
                                <div class="card mt-4">
                                    <div class="card-body">
                                        <div class="text-center">
                                            ...
                                            <h5>Create your question here</h5>
