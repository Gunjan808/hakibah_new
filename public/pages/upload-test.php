					...
					<form class="p-3" method="POST" enctype="multipart/form-data" id="documentAddForm">
						<div id="tabsWithIcons" class="col-xl-12 col-lg-12 col-12 layout-spacing pb-0">
							<div class="widget-content widget-content-area rounded-pills-icon">
								...
								<ul class="nav nav-pills  mt-1" id="rounded-pills-icon-tab" role="tablist" style="justify-content: space-between; margin-left:18%; margin-right:18%;">
									...
									<li class="nav-item ml-2 mr-2">
										<a class="nav-link mb-2 text-center <?php is($_SESSION['uploadedDocs'], 'array') and print(' disabled') ?>" id="rounded-pills-icon-profile-tab" data-toggle="pill" href="<?php is($_SESSION['uploadedDocs'], 'array') or print('#rounded-pills-icon-profile') ?>" role="tab" aria-controls="rounded-pills-icon-profile" aria-selected="false" aria-disabled="true">
										...
										<?php if (is($_SESSION['uploadedDocs'], 'array')) : ?>
											<?php foreach ($_SESSION['uploadedDocs'] as $doc) : ?>
												<div class="row my-4 shadow p-5" style="border-radius: 25px;">
													<svg class="ic ic-course ic-course--small mr-2" width="20" height="25" viewBox="0 0 16 12">
													...
													<h5 style="color: #5bc787;"> Software engineering</h5>
													<div class="col-md-12">
