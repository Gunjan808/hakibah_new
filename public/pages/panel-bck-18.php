            ...
            <div class="col-md-3 bg-light" style="max-width: 285px;">
                <div class="d-none d-md-block">
                    <div class="d-flex p-3 py-4" style="flex-direction: row; align-items: center;">
                        ...
                        <h5 class="mb-0 ml-3">
                            <?php is($_SESSION['USER_NAME'], 'showCapital'); ?>
                        </h5>
                    </div>

                    <div class="px-3 bg-primary text-white p-2 rounded">
                    ...
                    <div class="p-2 pt-3 pb-2">
                        <span class="font-weight-bold text-secondary mb-3" style="font-size:14px">
                            My Library
                        </span>
<style>
    ...
    border: 1px solid #73d0f4 !important;
                                ...
                                <div class="card-header" id="headingOne">
                                    <span class="text-dark" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <div class="d-flex text-primary" style="align-items: center; justify-self: space-between;">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-folder">
                                ...
                                <div class="card-header" id="headingTwo">
                                    <span class="text-dark collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <div class="d-flex text-primary">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-book">
                                    ...
                                    <span class="text-dark collapsed" data-toggle="collapse" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                        <div class="d-flex text-primary">
                                            <svg width="18" height="18" viewBox="0 0 448 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M85.3333 448.001C97.1154 448.001 106.667 438.449 106.667 426.667C106.667 414.885 97.1154 405.334 85.3333 405.334C73.5513 405.334 64 414.885 64 426.667C64 438.449 73.5513 448.001 85.3333 448.001Z" fill="#67C03D" />
                                                <path d="M431.664 319.999C439.913 310.798 445.319 299.404 447.231 287.196C449.142 274.987 447.477 262.486 442.435 251.204C437.394 239.921 429.192 230.341 418.822 223.62C408.452 216.899 396.357 213.326 384 213.333H256V170.666C255.982 153.698 249.233 137.43 237.235 125.431C225.236 113.433 208.968 106.684 192 106.666H149.333C143.675 106.666 138.249 108.914 134.248 112.914C130.248 116.915 128 122.341 128 127.999V213.333H21.3333C15.6754 213.333 10.2492 215.58 6.24839 219.581C2.24761 223.582 0 229.008 0 234.666V490.666C0 496.324 2.24761 501.75 6.24839 505.751C10.2492 509.752 15.6754 511.999 21.3333 511.999H149.333C154.991 511.999 160.418 509.752 164.418 505.751C168.419 501.75 170.667 496.324 170.667 490.666V490.463C189.081 504.429 211.556 511.992 234.667 511.999H384C396.357 512.006 408.452 508.433 418.822 501.712C429.192 494.991 437.394 485.411 442.435 474.129C447.477 462.846 449.142 450.345 447.231 438.137C445.319 425.928 439.913 414.534 431.664 405.333C442.182 393.61 448 378.416 448 362.666C448 346.916 442.182 331.722 431.664 319.999V319.999ZM128 469.333H42.6667V255.999H128V469.333ZM384 341.333C389.658 341.333 395.084 343.58 399.085 347.581C403.086 351.582 405.333 357.008 405.333 362.666C405.333 368.324 403.086 373.75 399.085 377.751C395.084 381.752 389.658 383.999 384 383.999C378.342 383.999 372.916 386.247 368.915 390.248C364.914 394.249 362.667 399.675 362.667 405.333C362.667 410.991 364.914 416.417 368.915 420.418C372.916 424.418 378.342 426.666 384 426.666C389.658 426.666 395.084 428.914 399.085 432.914C403.086 436.915 405.333 442.341 405.333 447.999C405.333 453.657 403.086 459.084 399.085 463.084C395.084 467.085 389.658 469.333 384 469.333H234.667C217.698 469.314 201.43 462.566 189.432 450.567C177.434 438.569 170.685 422.301 170.667 405.333V149.333H192C197.658 149.333 203.084 151.58 207.085 155.581C211.086 159.582 213.333 165.008 213.333 170.666V234.666C213.333 240.324 215.581 245.75 219.582 249.751C223.583 253.752 229.009 255.999 234.667 255.999H384C389.658 255.999 395.084 258.247 399.085 262.248C403.086 266.249 405.333 271.675 405.333 277.333C405.333 282.991 403.086 288.417 399.085 292.418C395.084 296.418 389.658 298.666 384 298.666C378.342 298.666 372.916 300.914 368.915 304.914C364.914 308.915 362.667 314.341 362.667 319.999C362.667 325.657 364.914 331.084 368.915 335.084C372.916 339.085 378.342 341.333 384 341.333Z" fill="#67C03D" />
                                                <path d="M170.667 0H213.334V42.6667H170.667V0Z" fill="#67C03D" />
                                                <path d="M86.3848 52.5859L116.55 22.4206L146.719 52.5897L116.554 82.755L86.3848 52.5859Z" fill="#67C03D" />
                                                <path d="M237.216 52.6035L267.385 22.4344L297.546 52.596L267.377 82.7651L237.216 52.6035Z" fill="#67C03D" />
                                            </svg>
                                            <span class="ml-3 text-dark"><a href="<?php echo SITE_URL; ?>likedlist/<?php echo $_SESSION['USER_ID'] ?>">Liked List</a></span>
                                            <div class="ml-auto mr-0 text-dark">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down">
                    ...
                    <div class="p-1 px-3 pl-4 rounded">
                        <a class="d-inline-flex text-decoration-none" href="<?php echo SITE_URL; ?>user/uploads">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-up-circle">
                                <circle cx="12" cy="12" r="10"></circle>
            ...
            <div class="col">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <form class="mt-3" action="<?php echo SITE_URL; ?>search" method="post">
                        ...
                        <div class="col-md-12 py-4">
                            <h5>My Courses and Books
                                <svg width="20" height="15" data-toggle="modal" data-target="#myModal" viewBox="0 0 428 428" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php if (is($data['studyLists'])) : ?>
                            <div class="col-md-12 py-4">
                                <h5>My Studylists
                                    <svg width="20" height="15" data-toggle="modal" data-target="#myModal3" viewBox="0 0 428 428" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M214 428C332.189 428 428 332.189 428 214C428 95.8111 332.189 0 214 0C95.8111 0 0 95.8111 0 214C0 332.189 95.8111 428 214 428Z" fill="#219EBC" />
                                        <path d="M189.492 164.305H236.367L243.008 361.375H182.852L189.492 164.305ZM212.93 133.445C203.424 133.445 195.807 130.646 190.078 125.047C184.219 119.448 181.289 112.286 181.289 103.562C181.289 94.969 184.219 87.872 190.078 82.273C195.807 76.674 203.424 73.875 212.93 73.875C222.305 73.875 229.922 76.674 235.781 82.273C241.51 87.872 244.375 94.969 244.375 103.562C244.375 112.156 241.51 119.253 235.781 124.852C229.922 130.581 222.305 133.445 212.93 133.445Z" fill="white" />
                                    </svg>
                                </h5>
                        ...
                        <?php if (is($data) and is($data['recent_docs'], 'array')) : ?>
                            <div class="col-md-12 my-4">
                                <h4 class="mb-3">
                                    My Recent Documents
                                    <svg width="20" height="15" data-toggle="modal" data-target="#myModal2" viewBox="0 0 428 428" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M214 428C332.189 428 428 332.189 428 214C428 95.8111 332.189 0 214 0C95.8111 0 0 95.8111 0 214C0 332.189 95.8111 428 214 428Z" fill="#219EBC" />
                                        <path d="M189.492 164.305H236.367L243.008 361.375H182.852L189.492 164.305ZM212.93 133.445C203.424 133.445 195.807 130.646 190.078 125.047C184.219 119.448 181.289 112.286 181.289 103.562C181.289 94.969 184.219 87.872 190.078 82.273C195.807 76.674 203.424 73.875 212.93 73.875C222.305 73.875 229.922 76.674 235.781 82.273C241.51 87.872 244.375 94.969 244.375 103.562C244.375 112.156 241.51 119.253 235.781 124.852C229.922 130.581 222.305 133.445 212.93 133.445Z" fill="white" />
                                    </svg>
                                </h4>
                                        ...
                                        <div class="col-xl-2 col-lg-4 col-md-6 mb-4">
                                            <div class="card shadow">
                                                <div class="card-body p-0 rounded-lg">
                                                    <div class="pt-4 px-3 text-center" style="background: #aaa; height: 120px; overflow: hidden;">
                        ...
                        <?php if (is($data) and is($data['recent_docs'], 'array')) : ?>
                            <div class="col-md-12 my-4">
                                <h4 class="mb-3">
                                    Recommendations
                                    <svg width="20" height="15" data-toggle="modal" data-target="#myModal1" viewBox="0 0 428 428" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M214 428C332.189 428 428 332.189 428 214C428 95.8111 332.189 0 214 0C95.8111 0 0 95.8111 0 214C0 332.189 95.8111 428 214 428Z" fill="#219EBC" />
                                        <path d="M189.492 164.305H236.367L243.008 361.375H182.852L189.492 164.305ZM212.93 133.445C203.424 133.445 195.807 130.646 190.078 125.047C184.219 119.448 181.289 112.286 181.289 103.562C181.289 94.969 184.219 87.872 190.078 82.273C195.807 76.674 203.424 73.875 212.93 73.875C222.305 73.875 229.922 76.674 235.781 82.273C241.51 87.872 244.375 94.969 244.375 103.562C244.375 112.156 241.51 119.253 235.781 124.852C229.922 130.581 222.305 133.445 212.93 133.445Z" fill="white" />
                                    </svg>
                                </h4>
