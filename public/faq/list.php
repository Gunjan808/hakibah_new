...
<?php empty($FaqData->type) or breadcrumb_start($FaqData->type, 'add/faq', 'post_list'); ?>
			...
			<div class="table-responsive mb-4 mt-4">
				<table id="multi-column-ordering" class="style-3 table table-hover" style="width:100%">
					...
					<tbody class="text-center">
						<?php $i = 1;
						if (is($FaqData, 'json') and is($FaqData->data, 'array')) :
							foreach ($FaqData->data as $key => $value) : ?>
								<tr>
									<td><?php echo $i++; ?>.</td>
										...
										<td class="text-center">
											<ul class="table-controls">
												<?php if (user_can('post_edit')) : ?>
													<li>
														<a href="<?php echo SITE_URL . 'edit/faq/' . $value->id;  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
												...
												<?php if (user_can('post_delete')) : ?>
													<li>
														<a href="<?php echo SITE_URL . 'delete/faq/' . $value->id;  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
