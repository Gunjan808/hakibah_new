...
<?php breadcrumb_start($userData->type, 'add/lead', 'lead_list'); ?>
					...
					<tbody>
						<?php if (is($userData) and is($userData->data, 'array')) :
							...
							foreach ($userData->data as $key => $value) :
								...
								$value->status === '17' and $status = ' ASSOCIATE PROGRAM ' and $class = 'info';
								if ($value->status !== '14' or $value->status !== '15') : ?>
									<tr>
										...
										<td>
											<?php is($value->about, 'showCapital'); ?>
										</td>
										<td>
										...
										<td class="text-center">
											<ul class="table-controls">
												...
												<?php if (user_can('lead_delete')) : ?>
													<li>
														<a href="<?php echo SITE_URL . 'delete/lead/' . $value->id; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
