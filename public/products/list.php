...
<?php empty($productData->type) or breadcrumb_start($productData->type, 'add/product', 'product_add'); ?>
			...
			<div class="table-responsive mb-4 mt-4">
				<table id="multi-column-ordering" class="style-3 table table-hover" style="width:100%">
					...
					<tbody class="text-center">
						<?php if (is($productData, 'json') and is($productData->data, 'array')) :
							$i = 1;
							foreach ($productData->data as $key => $value) :
								$value->status === '0' and $status = ' New ' 	and $class = 'info';
								$value->status === '1' and $status = ' Approved ' and $class = 'success';
								...
								<tr>
									...
									<td class="text-center">
										<ul class="table-controls">
											<li>
												<a href="<?php echo SITE_URL . 'product/' . $value->slug; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="View">
											...
											<?php if (user_can('product_edit')) : ?>
												<li>
													<a href="<?php echo SITE_URL . 'edit/product/' . $value->slug; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
											...
											<?php if (user_can('product_delete')) : ?>
												<li>
													<a href="<?php echo SITE_URL . 'delete/product/' . $value->slug; ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
