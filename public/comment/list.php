...
<?php empty($commentData->type) or breadcrumb_start($commentData->type, 'add/comment', 'comment_add'); ?>
			...
			<div class="table-responsive mb-4 mt-4">
				<table id="multi-column-ordering" class="style-3 table table-hover" style="width:100%">
					...
					<tbody class="text-center">
						<?php $i = 1;
						if (!empty($commentData) and !empty($commentData->data)) :

							foreach ($commentData->data as $key => $value) :
								...
								<tr>
									...
									<td class="text-center">
										<ul class="table-controls">
											<li>
												<a href="<?php echo SITE_URL . 'edit/comment/' . $value->id;  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
											...
											<li>
												<a href="<?php echo SITE_URL . 'delete/comment/' . $value->id;  ?>" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete">
